<div>
    ...
    <flux:modal name="edit-venta" variant="flyout">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Editar Venta</flux:heading>
                <flux:text class="mt-2">Complete los detalles de la venta.</flux:text>
            </div>
            <form wire:submit.prevent="updateVenta" class="space-y-4">
                ...
                <flux:input type="date" wire:model="fecha_venta" label="Fecha de Venta"
                ...
                <div class="flex">
                    ...
                    <flux:button type="submit" variant="primary">Editar venta</flux:button>
                </div>
            </form>
        </div>
    </flux:modal>
