<div>
    ...
    <flux:modal name="edit-compra" variant="flyout">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Editar Compra</flux:heading>
                <flux:text class="mt-2">Complete los detalles de la compra.</flux:text>
            </div>
            <form wire:submit.prevent="updateCompra" class="space-y-4">
